...
class _BottomNavigationBarExampleState
  ...
  void _onItemTapped(int index) {
    ...
    if (index == 1) {
      ...
      // Notifier que le feed est visible
      _feedKey.currentState?.setPageVisibility(true);
    } else {
      // Notifier que le feed n'est pas visible
      _feedKey.currentState?.setPageVisibility(false);
    }
