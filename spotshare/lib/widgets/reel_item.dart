...
class _ReelItemState extends State<ReelItem> with TickerProviderStateMixin {
  ...
  Future<void> _initializeMedia() async {
    ...
    bool detected = ['.mp4', '.mov', '.avi', '.mkv'].any((e) => url.toLowerCase().endsWith(e));
  ...
  Future<void> _toggleLike() async {
    ...
    PostService.notifyPostUpdated(widget.post.copyWith(
      isLiked: _isLiked,
      likes: _likesCount,
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            child: Stack(
              ...
              children: [
                _buildMediaContent(),
                if (_isVideo && _videoController != null && _videoController!.value.isInitialized && !_videoController!.value.isPlaying)
                  Center(
                    child: Container(
                      ...
                      child: Icon(Icons.play_arrow, size: 50, color: Colors.white.withOpacity(0.9)),
                    ),
                  ),
              ],
            ),
      ...
      child: GestureDetector(
        ...
        child: Column(
          children: [
            ...
            Icon(icon, color: color, size: 36, shadows: [
