...
class _MapSelectorPageState extends State<MapSelectorPage> {
  ...
  Future<void> _geolocateUser() async {
    try {
      ...
      if (pingImageBytes != null && _pointAnnotationManager != null) {
        ...
        _pointAnnotation = await _pointAnnotationManager!.create(options);
      }

      // Centrer la map sur la position de l'utilisateur
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Erreur de géolocalisation: $e')));
    }
  }
            ...
            child: Column(
              ...
              children: [
                ElevatedButton(
                  ...
                  onPressed: _geolocateUser,
                  child: const Text("Ma localisation"),
                ),
