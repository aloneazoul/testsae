...
class _StoryPlayerPageState extends State<StoryPlayerPage> {
  ...
  void _startStory() {
    ...
    // CORRECTION : Accès aux propriétés de l'objet
  ...
  Widget build(BuildContext context) {
    ...
    // CORRECTION : Utilisation de la date typée
